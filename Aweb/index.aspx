<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Aweb.index" %>
<!DOCTYPE html>
	...
	<body>
		...
		<div class="container">
			<header class="clearfix">
				<span>Blueprint</span>
				<h1>Horizontal Drop-Down Menu</h1>
				<nav>
			...
			<div class="main">
               ...
               <asp:Button ID="Button1" runat="server" Text="Insertar raiz" OnClick="Button1_Click" /> <br><br/><br><br/>
                    
               <asp:Button ID="Button2" runat="server" Text="Insertar " OnClick="Button1_Click" /> <br><br/><br><br/>
               
               <br><br/><br><br/>
               LOS ELEMENTOS DEL ARBOL SON : <asp:Label ID="Label1" runat="server"></asp:Label><br><br/><br><br/>

                RESULTADOS <br><br/><asp:Label ID="Label2" runat="server" Text="Label"></asp:Label><br><br/><br><br/>
